...
USER_DIR = os.path.expanduser("~/.chepe")
changed = 0

# check os compatibility
if (system := system()) == "Windows":
    print("windows is not currently supported. install wsl and use vape there.")
    sys.exit(1)
...
parser.add_argument("-w", action="store_true",
                    help="Eliminar la aplicación Watch")
parser.add_argument("-d", action="store_true",
                    help="Habilitar el acceso a archivos")
parser.add_argument("-s", action="store_true",
                    help="Fakesigns el ipa (para usar con appsync)")
parser.add_argument("-e", action="store_true",
                    help="Eliminar extensiones de aplicaciones")
parser.add_argument("-p", action="store_true",
                    help="Inyectar en @executable_path")
parser.add_argument("-t", action="store_true",
                    help="Usar sustituto en lugar de sustrato")
parser.add_argument("-z", action="store_true",
                    help="Usa 7zip en lugar de zip")
...
# injecting stuff
if args.f:
    ENT_PATH = os.path.join(APP_PATH, 'inject_By_chptechpro')
    ...
    DYLIBS_PATH = os.path.join(REAL_EXTRACT_DIR, "vape-inject")
...
if args.r:
    ...
    plist["CFBundleURLTypes"].append({
        "CFBundleURLName": "fyi.chepe.vape",
...
if args.k:
    ...
    IMG_PATH = os.path.join(EXTRACT_DIR, "vape_img.png")
